 ...
 *  - model 用 Tag color="orange" 高亮：它是 /model 命令的主体 + 唯一可变字段，视觉提权。
    ...
    >
      <Descriptions size="small" column={1} labelStyle={{ width: 96, color: '#666' }}>
        <Descriptions.Item label="模型">
          <Tag color="orange">{config.model}</Tag>
        </Descriptions.Item>
        <Descriptions.Item label="Provider">
          <ApiOutlined style={{ marginRight: 6, color: '#F26522' }} />
          {config.provider}
        </Descriptions.Item>
        <Descriptions.Item label="Base URL">
          <GlobalOutlined style={{ marginRight: 6, color: '#F26522' }} />
